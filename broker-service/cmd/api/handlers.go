...
import (
	...
	"encoding/json"
	"errors"
	"github.com/kleczynski/broker/event"
	"github.com/kleczynski/broker/logs"
...
func (app *Config) logItem(w http.ResponseWriter, entry LogPayload) {
	...
	logServiceULR := "http://logger-service/log"

	request, err := http.NewRequest("POST", logServiceULR, bytes.NewBuffer(jsonData))
	if err != nil {
		app.errorJSON(w, err)
		return
	}
